...
export class AuthorServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, isActive: boolean | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AuthorDtoPagedResultDto> {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<AuthorDto> {
        let url_ = this.baseUrl + "/api/services/app/Author/Get?";
        if (id === null)
    ...
    getAllAuthors(): Observable<AuthorDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Author/GetAllAuthors";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllAuthors(response: HttpResponseBase): Observable<AuthorDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    create(body: CreateAuthorDto | undefined): Observable<AuthorDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<AuthorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: AuthorDto | undefined): Observable<AuthorDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<AuthorDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class BookCategoryServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAllBookCategories(): Observable<BookCategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/GetAllBookCategories";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllBookCategories(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllBookCategories(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<BookCategoryDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookCategoryDto[]>;
        }));
    }

    protected processGetAllBookCategories(response: HttpResponseBase): Observable<BookCategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(BookCategoryDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BookCategoryDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BookCategoryDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookCategoryDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<BookCategoryDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BookCategoryDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<BookCategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<BookCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BookCategoryDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: CreateBookCategoryDto | undefined): Observable<BookCategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<BookCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: BookCategoryDto | undefined): Observable<BookCategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<BookCategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/BookCategory/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class BorrowerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BorrowerDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Borrower/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BorrowerDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BorrowerDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<BorrowerDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BorrowerDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<BorrowerDto> {
        let url_ = this.baseUrl + "/api/services/app/Borrower/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<BorrowerDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateIsBorrowedIfDeleted(body: BorrowerDto | undefined): Observable<void> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateIsBorrowedIfDeleted(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Borrower/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class DepartmentServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DepartmentDtoPagedResultDto> {
    ...
    getAllDepartments(): Observable<DepartmentDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Department/GetAllDepartments";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllDepartments(response: HttpResponseBase): Observable<DepartmentDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class BookCategoryDtoPagedResultDto implements IBookCategoryDtoPagedResultDto {
    items: BookCategoryDto[] | undefined;
    totalCount: number;

    constructor(data?: IBookCategoryDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(BookCategoryDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): BookCategoryDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new BookCategoryDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): BookCategoryDtoPagedResultDto {
        const json = this.toJSON();
        let result = new BookCategoryDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IBookCategoryDtoPagedResultDto {
    items: BookCategoryDto[] | undefined;
    totalCount: number;
}
...
export class BookDto implements IBookDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.bookPublisher = _data["bookPublisher"];
            this.authorId = _data["authorId"];
            this.author = _data["author"] ? AuthorDto.fromJS(_data["author"]) : <any>undefined;
            this.isBorrowed = _data["isBorrowed"];
            this.bookCategoryId = _data["bookCategoryId"];
            this.bookCategory = _data["bookCategory"] ? BookCategoryDto.fromJS(_data["bookCategory"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["bookPublisher"] = this.bookPublisher;
        data["authorId"] = this.authorId;
        data["author"] = this.author ? this.author.toJSON() : <any>undefined;
        data["isBorrowed"] = this.isBorrowed;
        data["bookCategoryId"] = this.bookCategoryId;
        data["bookCategory"] = this.bookCategory ? this.bookCategory.toJSON() : <any>undefined;
        return data;
    }
...
export class BorrowerDto implements IBorrowerDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.expectedReturnDate = _data["expectedReturnDate"] ? moment(_data["expectedReturnDate"].toString()) : <any>undefined;
            this.returnDate = _data["returnDate"] ? moment(_data["returnDate"].toString()) : <any>undefined;
            this.bookId = _data["bookId"];
            this.book = _data["book"] ? BookDto.fromJS(_data["book"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["expectedReturnDate"] = this.expectedReturnDate ? this.expectedReturnDate.toISOString() : <any>undefined;
...
export class BorrowerDtoPagedResultDto implements IBorrowerDtoPagedResultDto {
    items: BorrowerDto[] | undefined;
    totalCount: number;

    constructor(data?: IBorrowerDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BorrowerDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new BorrowerDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): BorrowerDtoPagedResultDto {
        const json = this.toJSON();
        let result = new BorrowerDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IBorrowerDtoPagedResultDto {
    items: BorrowerDto[] | undefined;
    totalCount: number;
}
...
export class CreateBookCategoryDto implements ICreateBookCategoryDto {
    name: string;
    departmentId: number;

    constructor(data?: ICreateBookCategoryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBookCategoryDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBookCategoryDto();
        result.init(data);
        return result;
    }
...
export class CreateBorrowerDto implements ICreateBorrowerDto {
    id: number;
    borrowDate: moment.Moment;
    expectedReturnDate: moment.Moment;
    returnDate: moment.Moment | undefined;
    ...
    constructor(data?: ICreateBorrowerDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBorrowerDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBorrowerDto();
        result.init(data);
        return result;
    }
...
export class StudentDto implements IStudentDto {
    ...
    studentContactNumber: string | undefined;
